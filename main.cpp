...
int main() {
    ...
    cout << "Macierz E po transpozycji:\n" << E << "\n";
    ...
    // Operatory strumieniowe i porównania [4.7]
    cout << "=== Test operatorów strumieniowych i porównañ (4.7) ===\n";

    matrix G(5, t_diag);  // nowa macierz do porównañ
